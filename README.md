...
## Academic Note
This repository contains solutions for the MKT4822 term project. It demonstrates the use of a local LLM agent to autonomously generate, validate, and execute Reinforcement Learning (Actor-Critic) and Dynamic Programming (Fibonacci) algorithms.
